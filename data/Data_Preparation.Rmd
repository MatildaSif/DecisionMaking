...
write.table(controls, "../data/IGTdata_healthy_control_clean.txt", 
            row.names = FALSE, quote = FALSE, sep = "\t")
write.table(heroin, "../data/IGTdata_heroin_clean.txt", 
            row.names = FALSE, quote = FALSE, sep = "\t")
write.table(amp, "../data/IGTdata_amphetamine_clean.txt", 
            row.names = FALSE, quote = FALSE, sep = "\t")
